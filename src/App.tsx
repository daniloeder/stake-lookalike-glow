...
const App = () => {
  ...
  // Define sidebar items for Casino page based on the provided structure
      ...
      <TooltipProvider>
        <BrowserRouter>
          <div className={`app-container ${collapsed ? 'sidebar-collapsed' : ''}`}>
            <Sidebar collapsed={collapsed} toggleSidebar={toggleSidebar} sidebarItems={casinoSidebarItems} />
